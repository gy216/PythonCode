...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QTabWidget, QToolBar, QLineEdit,
                             QAction, QWidget, QHBoxLayout, QStatusBar, QMessageBox, QMenu, QVBoxLayout)
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('logo.png'))  # 确保图标文件存在
    ...
    def createToolbar(self):
        ...
        navigation_actions = {
            'Back': ('go-previous', '返回', self.navigateBack),
            'Forward': ('go-next', '前进', self.navigateForward),
            'Stop': ('process-stop', '停止加载', self.stopLoading),
            'Reload': ('view-refresh', '刷新', self.reloadPage),
            'NewTab': ('tab-new', '新标签页', self.newTab),
            'About': ('help-about', '关于', self.showAbout),
        }

        for action_name, (icon, tip, method) in navigation_actions.items():
    ...
    def showAbout(self):
        ...
        msg.setText("果园编程工作室制作，©2023-2026版权所有\n官网：https://gy216.github.io/")
        msg.exec_()
